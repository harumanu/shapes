define(['jquery', 'shapes/Shape', 'raphael'], function ( $, Shape, Raphael ) {
    ...
    Triangle.prototype._renderShape = function () {
        ...
        this._renderText(center.x, yStart - displayHeight / 3, this.area.toFixed(2), 16);
        this._renderText(xStart + displayWidth / 2, yStart + 20, this.x.toFixed(2), 12);
    };
